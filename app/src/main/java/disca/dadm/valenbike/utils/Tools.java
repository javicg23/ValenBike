...
public class Tools {
    ...
    public static List<StationGUI> getStationsGui() {
        ...
        stations.add(new StationGUI(156, "valence", "", "Puerto Rico - Cuba",
                new Position(39.460932063112466, -0.376436094678165), false,
                false, 20, 10, 10, "OPEN", 1585552200));

        stations.add(new StationGUI(187, "valence", "", "Ángel Villena - Ausias March",
                new Position(39.447928021676226, -0.368909065084874), false,
                false, 20, 10, 10, "CLOSED", 1585552200));

        stations.add(new StationGUI(44, "valence", "", "General Urrutia - Av. de la Plata",
                new Position(39.456397052131265, -0.363105052261891), false,
                false, 20, 10, 10, "OPEN", 1585552200));

        stations.add(new StationGUI(29, "valence", "", "Plaza América - Cirilo Amorós - Sorní",
                new Position(39.47008009754055, -0.36539006649012), true,
                false, 20, 10, 10, "CLOSED", 1585552200));

        stations.add(new StationGUI(83, "valence", "", "General Elio - Llano del Real",
                new Position(39.47755312220108, -0.367061075518166), false,
                false, 20, 10, 0, "OPEN", 1585552200));

        stations.add(new StationGUI(92, "valence", "", "Blasco Ibañez - Aragón",
                new Position(39.475828119933816, -0.356059041618514), false,
                false, 20, 10, 10, "OPEN", 1585552200));

        stations.add(new StationGUI(50, "valence", "", "Autopista del Saler - Antonio Ferrandis (C.C. El Saler)",
                new Position(39.453286044933414, -0.352950020141597), true,
                false, 20, 10, 10, "CLOSED", 1585552200));

        stations.add(new StationGUI(273, "valence", "", "Moraira - Alta del Mar",
                new Position(39.450273041140704, -0.33336295982062), false,
                false, 20, 10, 10, "OPEN", 1585552200));

        stations.add(new StationGUI(79, "valence", "", "Aragón - Ernesto Ferrer",
                new Position(39.47274710913562, -0.357333043778256), false,
                false, 20, 10, 10, "CLOSED", 1585552200));

        stations.add(new StationGUI(72, "valence", "", "Ramiro de Maeztu - Peris Brell",
                new Position(39.467225, -0.346537), false,
                false, 20, 10, 10, "OPEN", 1585552200));

        stations.add(new StationGUI(163, "valence", "", "Paseo Neptuno 32-34",
                new Position(39.464405091973795, -0.323491937905993), false,
                false, 20, 10, 10, "CLOSED", 1585552200));

        stations.add(new StationGUI(161, "valence", "", "Mediterráneo - Plaza Cruz de Cañamelar",
                new Position(39.467937101175984, -0.331816964744236), false,
                false, 20, 10, 10, "OPEN", 1585552200));

        stations.add(new StationGUI(169, "valence", "", "Pavía (Instituto Isabel de Villena)",
                new Position(39.478753139905066, -0.324735949373236), true,
                false, 20, 10, 10, "OPEN", 1585552200));

        stations.add(new StationGUI(125, "valence", "", "Masquefa, 42 - 44",
                new Position(39.489661165707126, -0.358709056987903), false,
                false, 20, 10, 10, "CLOSED", 1585552200));

        stations.add(new StationGUI(231, "valence", "", "Alcañiz - Cambrils",
                new Position(39.495040177417366, -0.378712119815713), true,
                false, 20, 10, 10, "OPEN", 1585552200));

        stations.add(new StationGUI(139, "valence", "", "Reus - Alquería de la Estrella",
                new Position(39.4856741444693, -0.382964127549696), true,
                false, 20, 10, 10, "CLOSED", 1585552200));

        stations.add(new StationGUI(143, "valence", "", "Pio XII - Menéndez PIdal (Nuevo Centro)",
                new Position(39.4795051210676, -0.391027148421504), true,
                false, 20, 10, 10, "CLOSED", 1585552200));

        stations.add(new StationGUI(268, "valence", "", "Plaza Luis Cano, 5",
                new Position(39.50141318615774, -0.418584242795808), false,
                false, 20, 10, 10, "OPEN", 1585552200));

        stations.add(new StationGUI(247, "valence", "", "Tres Cruces - Músico Ayllón",
                new Position(39.46737807542721, -0.405664185821979), true,
                false, 20, 10, 10, "OPEN", 1585552200));

        stations.add(new StationGUI(3, "valence", "", "Plaza del Musico López Chavarri",
                new Position(39.4768031153802, -0.38037911504075), true,
                false, 20, 10, 10, "OPEN", 1585552200));

        stations.add(new StationGUI(200, "valence", "", "Av. del Cid - Julián Peña",
                new Position(39.4677050805168, -0.393305148918046), false,
                false, 20, 10, 10, "CLOSED", 1585552200));
